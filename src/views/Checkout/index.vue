...
<template>
  ...
  <el-dialog v-model="showDialog" title="切换收货地址" width="30%" center>
    <div class="addressWrapper">
      <div class="text item" :class="{active: activeAddress.id === item.id}" v-for="item in checkInfo.userAddresses"  :key="item.id" @click="showActiveAddress(item)">
        <ul>
